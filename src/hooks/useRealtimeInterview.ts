...
${resumeText.slice(0, 20000)}`,
      ...
      pc.addEventListener("track", (e) => {
        ...
        remoteAudioRef.current
          .play()
          .catch((err) => console.warn("[Realtime] Autoplay blocked, awaiting user gesture", err));
        ...
        // Also route audio to the system output through AudioContext to ensure playback
        source.connect(audioContext.destination);

        setAudioAnalyser(analyser);
        console.log("[Realtime] Audio analyser connected");
      });
