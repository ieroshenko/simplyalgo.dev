...
import { CurrentRoleStep } from '@/components/survey/steps/CurrentRoleStep';
import { InterviewFrequencyStep } from '@/components/survey/steps/InterviewFrequencyStep';
import { SourceStep } from '@/components/survey/steps/SourceStep';
import { PlatformExperienceStep } from '@/components/survey/steps/PlatformExperienceStep';
import { LongTermResultsStep } from '@/components/survey/steps/LongTermResultsStep';
import { InterviewingLocationStep } from '@/components/survey/steps/InterviewingLocationStep';
import { InterviewAssessmentFrequencyStep } from '@/components/survey/steps/InterviewAssessmentFrequencyStep';
import { FrustrationsStep } from '@/components/survey/steps/FrustrationsStep';
import { GoalsStep } from '@/components/survey/steps/GoalsStep';
import { BottlenecksStep } from '@/components/survey/steps/BottlenecksStep';
import { SocialProofStep } from '@/components/survey/steps/SocialProofStep';
import { CustomizationIntroStep } from '@/components/survey/steps/CustomizationIntroStep';
import { CompanyTypeStep } from '@/components/survey/steps/CompanyTypeStep';
import { FocusAreasStep } from '@/components/survey/steps/FocusAreasStep';
import { SessionsPerWeekStep } from '@/components/survey/steps/SessionsPerWeekStep';
import { PlanGenerationIntroStep } from '@/components/survey/steps/PlanGenerationIntroStep';
