    ...
    <div className="bg-secondary/50 p-4 mx-6 mt-6 rounded-lg border border-secondary">
      <div className="flex items-center justify-between">
        ...
        <div className="text-right">
          ...
          <div className="text-sm text-muted-foreground">Keep pushing forward!</div>
        </div>
      </div>
      ...
      <div className="flex items-center space-x-8 mt-2">
        <div className="flex items-center space-x-2">
          ...
          <span className="font-semibold text-foreground">Streak: 3</span>
        </div>
        
        <div className="flex items-center space-x-2">
          <Clock className="w-4 h-4 text-muted-foreground" />
          <span className="text-sm text-muted-foreground">System Design: TinyURL at 20:00</span>
        </div>
      </div>
    </div>
  );
