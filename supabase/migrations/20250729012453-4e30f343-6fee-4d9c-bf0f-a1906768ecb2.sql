-- Complete Blind 75 Problems Migration - Part 1 (Fixed)
...
WITH category_ids AS (
  SELECT id as array_hashing_id FROM categories WHERE name = 'Array & Hashing'
)
...
SELECT 
  'valid-anagram', 'Valid Anagram', 'Easy', array_hashing_id,
...
SELECT 
  'group-anagrams', 'Group Anagrams', 'Medium', array_hashing_id,
...
SELECT 
  'top-k-frequent-elements', 'Top K Frequent Elements', 'Medium', array_hashing_id,
...
SELECT 
  'product-of-array-except-self', 'Product of Array Except Self', 'Medium', array_hashing_id,
...
SELECT 
  'encode-and-decode-strings', 'Encode and Decode Strings', 'Medium', array_hashing_id,
...
SELECT 
  'longest-consecutive-sequence', 'Longest Consecutive Sequence', 'Hard', array_hashing_id,
